...
class Crawler:
    ...
    def __init__(self, urls=[], max_rows=20, base_domain='nytimes.com', max_threads=4):
    ...
    def crawl(self, url):
        ...
        if html and status_code == 200:
            ...
            valid_outlinks = [self.add_url_to_visit(linked_url) for linked_url in outlinks]
    ...
    def run(self):
        ...
        with open('fetch_FOXNews.csv', 'w', newline='', encoding='utf-8') as fetch_file, \
             open('visit_FOXNews.csv', 'w', newline='', encoding='utf-8') as visit_file, \
             open('urls_FOXNews.csv', 'w', newline='', encoding='utf-8') as urls_file:
            ...
            # Write headers
            fetch_writer.writerow(['URL', 'Status Code'])
            visit_writer.writerow(['URL', 'Size', 'Number of Outlinks', 'Content-Type'])
                ...
                while future_to_url and len(self.results) < self.max_rows:
                    for future in as_completed(future_to_url):
                        ...
                        try:
                            ...
                            # Submit new URLs found (outlinks) for crawling
...
if __name__ == '__main__':
    Crawler(urls=['https://www.nytimes.com'], max_threads=4).run()
